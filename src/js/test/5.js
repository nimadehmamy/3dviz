...
var cam_speed = .1;
var cam_loc= 5;
var nodes_loc= readMatrix('assets/network/nodes.txt',' ');
var edge_list= readMatrix('assets/network/edgelist.txt',' ');
var nodes = {};
...
for(i in nodes_loc){
  ...
  nodes[id] = new node(id, new THREE.Vector3(ii[0]-com[0],ii[1]-com[1],ii[2]-com[2]),degrees[i]/5.0);

...
THREE.OBJMTLExporter = function () {};

THREE.OBJMTLExporter.prototype = {

	constructor: THREE.OBJMTLExporter,
	...
	parse: function ( object ) {
		...
		var parseMesh = function ( mesh ) {
			...
			if ( geometry instanceof THREE.Geometry ) {
				...
				console.warn( 'THREE.OBJMTLExporter.parseMesh(): geometry type unsupported', mesh );
				// TODO: Support only BufferGeometry and use use setFromObject()
